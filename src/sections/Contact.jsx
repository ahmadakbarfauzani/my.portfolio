...
const contactInfo = [
    {
        icon: Mail,
        label: "Email",
        value: "ahmadakbarfauzani1@gmail.com",
        href: "mailto:ahmadakbarfauzani1@gmail.com",
    },
    {
        icon: Phone,
        label: "Phone",
        value: "+62 (813) 8921-3295",
        href: "tel:+6281389213295",
    },
    {
        icon: MapPin,
        label: "Location",
        ...
        <div className="container mx-auto px-6 relative z-10">
            ...
            <div className="text-center max-w-3xl mx-auto mb-16">
                ...
                <p className="text-muted-foreground animate-fade-in animation-delay-200">
                    ...
                    new design projects, creative ideas, or opportunities to be part of your visions. 
                </p>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-6 animate-fade-in animation-delay-400">
                ...
                <p className="text-muted-foreground text-sm">
                    Need a designer who speaks your brand’s language? 
                    From pixels to print, I’ve got you covered. 
                    Send over your brief and let's get to work!
